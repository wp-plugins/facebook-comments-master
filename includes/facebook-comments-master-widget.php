...
class facebook_comments_master_widget extends WP_Widget {
	...
	//Display Faceboook Comments
		...
		echo '<div id="fb-root"></div>' .
			...
			'<div class="fb-comments" data-href="'.$fburicurrent.'" data-width="'.$facebookcomments_width.'" data-num-posts="'.$facebookcomments_posts.'" data-colorscheme="'.$facebookcomments_color.'"></div>';
	echo $after_widget;
	}
	//Update the widget
...
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>
	...
	<p>
	<label for="<?php echo $this->get_field_id( 'facebookcomments_width' ); ?>"><?php _e('Plugin Width:', 'facebook_comments_master'); ?></label></br>
