<div class="wrap">
<div class="icon32" style="width:40px; vertical-align:middle;"><img src="../wp-content/plugins/facebook-comments-master/techgasp-minilogo.png" alt="' . esc_attr__( 'TechGasp Plugins') . '" /><br /></div>

<h2><b>TechGasp - Facebook Comments Master Lite Version</b></h2>
<form method="post" action="techgasp-facebookcommentsmaster-admin.php"> 
...
<img src="../wp-content/plugins/facebook-comments-master/techgasp-facebookcommentsmaster-logo.png" alt="Facebook Comments Master" align="left" width="387px" height="171px" style="padding:5px;"/>
<p><h2>Facebook Comments Master:</h2></p>
<p>Facebook Comments Master is the professional integration of facebook comments into heavy duty wordpress websites.</p>
</br>
<p><em>Facebook Comments Master is all about gain and viral...</em><p>
</br>
</br>
<p><h3>Options & Configuration:</h3></p>
<p><b>All configuration options are available in your widgets page. Facebook Comments Master Widget:</b></p>
<p>Select or <em>"add"</em > Facebook Comments Master Widget. Configure your settings. Select widget position according to your template. That easy...</p>
<p><b>Insert Facebook Comments Master Widget inside Pages and Posts (advanced version only):</b></p>
